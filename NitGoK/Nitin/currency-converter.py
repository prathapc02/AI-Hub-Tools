...
def show_data():
    amount = E1.get()
    from_currency = c1.get().strip()
    to_currency = c2.get().strip()
    ...
    if amount == '':
        ...
        try:
            ...
            if 'rates' not in data:
                raise KeyError("'rates' key not found in the response")
            ...
            messagebox.showerror("Currency Converter", f"Request error: {e}")
...
currencychoose1['values'] = ('USD',)  # You can add more base currencies here
...
currencychoose2['values'] = (
    'ALL', 'AFN', 'ARS', 'AWG', 'AUD', 'AZN', 'BSD', 'BBD', 'BYN', 'BZD', 'BMD', 'BOB', 'BAM', 'BWP',
    'BGN', 'BND', 'KHR', 'CAD', 'KYD', 'CLP', 'CNY', 'COP', 'CRC', 'HRK', 'CUP', 'CZK', 'DKK', 'DOP',
    'XCD', 'EGP', 'SVC', 'EUR', 'FKP', 'FJD', 'GHS', 'GIP', 'GTQ', 'GGP', 'GYD', 'HNL', 'HKD', 'HUF',
    'ISK', 'INR', 'IDR', 'IRR', 'IMP', 'ILS', 'JMD', 'JPY', 'KZT', 'KPW', 'KRW', 'KGS', 'LAK', 'LBP',
    'LRD', 'MKD', 'MYR', 'MUR', 'MXN', 'MNT', 'MZN', 'NAD', 'NPR', 'ANG', 'NZD', 'NIO', 'NGN', 'NOK',
    'OMR', 'PKR', 'PAB', 'PYG', 'PEN', 'PHP', 'PLN', 'QAR', 'RON', 'RUB', 'SHP', 'SAR', 'RSD', 'SCR',
    'SGD', 'SBD', 'SOS', 'ZAR', 'LKR', 'SEK', 'CHF', 'SRD', 'SYP', 'TWD', 'THB', 'TTD', 'TRY', 'TVD',
    'UAH', 'GBP', 'UYU', 'UZS', 'VEF', 'VND', 'YER', 'ZWD'
)
