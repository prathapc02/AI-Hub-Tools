...
bg_image_pil = Image.open('bg.PNG')

# Resize the image to match window dimensions
bg_image_resized_pil = bg_image_pil.resize((1000, 626), Image.LANCZOS)

# Convert PIL image to Tkinter-compatible format
bg_image = ImageTk.PhotoImage(bg_image_resized_pil)
